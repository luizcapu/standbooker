...
;(function($) {
  ...
  $.fn.simplePassMeter.defaults = {
    ...
    'offset': 10,                      // NUMBER  Pixels that the meter UI is offset from the password field.
    ...
    'requirements': {                 // OBJECT  All requirements that the password must fulfill.
      ...
      'minLength': {
        'value': 5,                   // VARIOUS  The value for any requirement must evaluate to true (hence no zeros, no false, no null), but can be requirement-specific as in the "minLength" case.
        ...
        'message': 'Sua senha deve ter %V caracteres ou mais' // STRING  The message to display to the user if they do not meet the requirement. It can contain the special sequence %V which will be replaced by the value parameter for this requirement.
      },
      'noMatchField': {
        ...
        'message': 'Sua senha não pode conter seu login'
      },
      'matchField': {
        'value': null,                // STRING  The jQuery search string for the node to restrict on
        'callback': function(p, v) {
      ...
      'letters': {'value': false, 'regex': '[a-zA-Z]+', 'message': 'Sua senha deve conter ao menos uma letra'},
      'numbers': {'value': false, 'regex': '[0-9]+', 'message': 'Sua senha deve conter ao menos um número'},
      
      // These requirements are turned off by default
      'lower': {'value': false, 'regex': '[a-z]+', 'message': 'Sua senha deve conter ao menos uma letra minúscula'},
      'upper': {'value': false, 'regex': '[A-Z]+', 'message': 'Sua senha deve conter ao menos uma letra maiúscula'},
      'special': {'value': false, 'regex': '[^a-zA-Z0-9]+', 'message': 'Sua senha deve conter ao menos um caracter especial'}
    },
    ...
    'ratings': [                              // ARRAY   The categories for the ratings. When an input hits the "minScore" for a given rating, its values will be used. NOTE THAT THESE MUST BE IN ORDER BY THE "minScore" ATTRIBUTE.
      {'minScore': 0,                         // NUMBER  The minimum score to hit to trigger this rating.
       ...
       'text': 'Senha Muito Fraca' // STRING  The text to place in the meter UI when this rating is triggered.
      },
      {'minScore': 25, 
       'className': 'meterWarn',
       'text': 'Senha Fraca'
