...
//            jsonOptions[options.endParam || 'end'] = Math.round(weekEndDate.getTime() / 1000);
            jsonOptions[options.startParam || 'start'] = weekStartDate.getDate()+"/"+weekStartDate.getMonth()+"/"+weekStartDate.getFullYear();
            jsonOptions[options.endParam || 'end'] = weekEndDate.getDate()+"/"+weekEndDate.getMonth()+"/"+weekEndDate.getFullYear();
      ...
      _updateDayColumnHeader : function ($weekDayColumns) {
         ...
         $weekDayColumns.each(function(i, val) {
            ...
            if ($(this).data("startDate").getHours() == 1) $(this).data("startDate").setHours($(this).data("startDate").getHours() - 1);
            if ($(this).data("endDate").getHours() == 1) $(this).data("endDate").setHours($(this).data("endDate").getHours() - 1);
      ...
      _dateFirstDayOfWeek : function(date) {
         var self = this;
         var midnightCurrentDate = new Date(date.getFullYear(), date.getMonth(), date.getDate(), 1);
   ...
   $.extend($.ui.weekCalendar, {
      ...
      defaults: {
         ...
         longMonths : ['Janeiro', 'Fevereiro', 'Marco', 'Abril', 'Naio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Dezembro'],
