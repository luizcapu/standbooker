...
$.extend($.validator, {
	...
	messages: {
		...
		login: "Informe um login válido (somente números e letras sem acênto)"
	},
...
*/			
		...
		validateLogin: function(psLogin) {
			padrao = /^[a-z\d_]{5,20}$/i;
			return padrao.exec(psLogin);
		},
	...
	methods: {
		...
		date: function(value, element) {
			...
			//return this.optional(element) || !/Invalid|NaN/.test(new Date(value)) || this.valida_data(element);
			return this.valida_data(element);
		},
		...
		time: function(value, element) {
			return this.valida_hora(element);
		},
